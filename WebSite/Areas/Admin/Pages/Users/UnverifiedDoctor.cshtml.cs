...
namespace WebSite.Areas.Admin.Pages.Users
{
    ...
    public class UnverifiedDoctorModel : PageModel
    {
        private readonly UserManager<User> _userManager;
        public UnverifiedDoctorModel(UserManager<User> userManager)
        {
        ...
        public void OnGet(UserRequestDto request, int? pageNumber)
        {
            ...
            var pageSize = 5;
            Users = PaginatedList<User>.Create(query.Where(u => !u.IsDelete && !u.IsDoctor).ToList(), pageNumber ?? 1, pageSize);
        }
    }
}
