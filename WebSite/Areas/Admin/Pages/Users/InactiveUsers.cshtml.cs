...
namespace WebSite.Areas.Admin.Pages.Users
{
    ...
    public class InactiveUsersModel : PageModel
    {
        private readonly UserManager<User> _userManager;

        public InactiveUsersModel(UserManager<User> userManager)
        {
        ...
        public void OnGet(UserRequestDto request, int? pageNumber)
        {
            ...
            var pageSize = 5;
            Users = PaginatedList<User>.Create(query.Where(u => !u.IsDelete && !u.EmailConfirmed).ToList(), pageNumber ?? 1, pageSize);
        }
    }
}
